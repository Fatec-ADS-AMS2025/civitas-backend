...
namespace Civitas.WebAPI.Data.Builders
{
    public class InstituicaoBuilder
    {
        public static void Build(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<Instituicao>().Property(i => i.Nome).IsRequired().HasMaxLength(150);
            modelBuilder.Entity<Instituicao>().Property(i => i.Logradouro).IsRequired().HasMaxLength(255);
            ...
            modelBuilder.Entity<Instituicao>().Property(i => i.NomeRazaoSocial).IsRequired().HasMaxLength(200);
            modelBuilder.Entity<Instituicao>().Property(i => i.Email).IsRequired().HasMaxLength(255);
            ...
            modelBuilder.Entity<Instituicao>().Property(i => i.Estado).IsRequired().HasMaxLength(2);
            ...
            modelBuilder.Entity<Instituicao>()
                .HasOne(i => i.Secretaria)
                .WithMany(s => s.Instituicoes)
                .HasForeignKey(i => i.IdSecretaria)
                .OnDelete(DeleteBehavior.Restrict);
        }
    }
}
