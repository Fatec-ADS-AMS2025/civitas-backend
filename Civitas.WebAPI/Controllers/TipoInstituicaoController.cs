...
namespace Civitas.WebAPI.Controllers
{
    ...
    public class TipoInstituicaoController : ControllerBase
    {
        ...
        {
            var result = await _tipoInstituicaoService.GetPageExcluidos(paginationQuery);

            _response.Code = ResponseEnum.SUCCESS;
            _response.Data = result;
            _response.Message = "Tipos de instituicao excluidos listados com sucesso";
        ...
        public async Task<IActionResult> ToggleStatusExclusao(int id)
        {
            try
            {
                var dto = await _tipoInstituicaoService.ToggleStatusExclusaoAsync(id);

                _response.Code = ResponseEnum.SUCCESS;
                _response.Data = dto;
                _response.Message = "Tipos de instituicao com status de exclusao alterado com sucesso";
                return Ok(_response);
            }
