...
namespace Civitas.WebAPI.Controllers
{
    ...
    public class UnidadeMedidaController : ControllerBase
    {
        ...
        {
            var result = await _unidadeMedidaService.GetPageExcluidos(paginationQuery);

            _response.Code = ResponseEnum.SUCCESS;
            _response.Data = result;
            _response.Message = "Unidades de medida excluidos listados com sucesso";
        ...
        public async Task<IActionResult> ToggleStatusExclusao(int id)
        {
            try
            {
                var dto = await _unidadeMedidaService.ToggleStatusExclusaoAsync(id);

                _response.Code = ResponseEnum.SUCCESS;
                _response.Data = dto;
                _response.Message = "Unidades de medida com status de exclusao alterado com sucesso";
                return Ok(_response);
            }
