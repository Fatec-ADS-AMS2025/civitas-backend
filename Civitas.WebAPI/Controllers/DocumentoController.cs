...
namespace Civitas.WebAPI.Controllers
{
    ...
    public class DocumentoController : ControllerBase
    {
        ...
        {
            var documentoDto = await _documentoService.GetPage(paginationQuery);
        ...
        {
            var result = await _documentoService.GetPageExcluidos(paginationQuery);

            _response.Code = ResponseEnum.SUCCESS;
            _response.Data = result;
            _response.Message = "Documentos excluidos listados com sucesso";
        ...
        public async Task<IActionResult> ToggleStatusExclusao(int id)
        {
            try
            {
                var dto = await _documentoService.ToggleStatusExclusaoAsync(id);

                _response.Code = ResponseEnum.SUCCESS;
                _response.Data = dto;
                _response.Message = "Documentos com status de exclusao alterado com sucesso";
                return Ok(_response);
            }
