...
namespace Civitas.WebAPI.Controllers
{
    ...
    public class SecretariaController : Controller
    {
        ...
        {
            var result = await _secretariaService.GetPageExcluidos(paginationQuery);

            _response.Code = ResponseEnum.SUCCESS;
            _response.Data = result;
            _response.Message = "Secretarias excluidos listados com sucesso";
        ...
        public async Task<IActionResult> ToggleStatusExclusao(int id)
        {
            try
            {
                var dto = await _secretariaService.ToggleStatusExclusaoAsync(id);

                _response.Code = ResponseEnum.SUCCESS;
                _response.Data = dto;
                _response.Message = "Secretarias com status de exclusao alterado com sucesso";
                return Ok(_response);
            }
