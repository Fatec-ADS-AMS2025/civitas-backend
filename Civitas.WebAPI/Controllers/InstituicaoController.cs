    ...
    public class InstituicaoController : ControllerBase
    {
        ...
        public async Task<IActionResult> GetGastosByInstituicao(int idInstituicao, int idTipoDespesa)
        {
            ...
            if (gastosInstituicao is null)
            {
                ...
                _response.Data = null;
                _response.Message = "Institui̤̣o ṇo encontrada";
                return NotFound(_response);
            }

            _response.Code = ResponseEnum.SUCCESS;
            _response.Data = gastosInstituicao;
            _response.Message = "Gastos da institui̤̣o obtidos com sucesso";
            return Ok(_response);
        }
        ...
        {
            var result = await _instituicaoService.GetPageExcluidos(paginationQuery);

            _response.Code = ResponseEnum.SUCCESS;
            _response.Data = result;
            _response.Message = "Instituicoes excluidos listados com sucesso";
        ...
        public async Task<IActionResult> ToggleStatusExclusao(int id)
        {
            try
            {
                var dto = await _instituicaoService.ToggleStatusExclusaoAsync(id);

                _response.Code = ResponseEnum.SUCCESS;
                _response.Data = dto;
                _response.Message = "Instituicoes com status de exclusao alterado com sucesso";
                return Ok(_response);
            }
            catch (KeyNotFoundException ex)
            {
